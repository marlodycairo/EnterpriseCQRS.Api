    ...
    public class ProductCommandHandler
    {
        ...
        public class CalculateTransactionCommandHandler : IRequestHandler<CalculateTransactionCommand, GenericResponse<IList<Total>>>
        {
            ...
            private static List<Conversiones> GetConversiones(List<Rates> rates, List<Transaction> transactions)
            {
                ...
                //conversiones.Add(new Conversiones() 
                //{ 
                //    CurrencyFinal = "EUR" 
                //});
                ...
                //for (int i = 0; i < conversiones.Count; i++)
                //{
                //    //Currency EUR
                //    if (conversiones[i].Currency == "EUR")
                //    {
                //        subtotal += decimal.Parse(conversiones[i].Amount);
                //        //resultado = subtotal * decimal.Parse(conversiones[i].Rate);
                //    }

                //    //Currency AUD
                //    if (conversiones[i].Currency == "AUD")
                //    {
                //        if (conversiones[i].From == "AUD" && conversiones[i].To == "EUR" && conversiones[i].Currency == "AUD")
                //        {
                //            subtotal += decimal.Parse(conversiones[i].Amount);
                //            resultado = subtotal * decimal.Parse(conversiones[i].Rate);
                //        }

                //        if (conversiones[i].From == "AUD" && conversiones[i].To == "CAD" && conversiones[i].Currency == "AUD")
                //        {
                //            subtotal += decimal.Parse(conversiones[i].Amount);
                //            resultado = subtotal * decimal.Parse(conversiones[i].Rate);
                //        }

                //        if (conversiones[i].From == "AUD" && conversiones[i].To == "USD" && conversiones[i].Currency == "AUD")
                //        {
                //            subtotal += decimal.Parse(conversiones[i].Amount);
                //            resultado = subtotal * decimal.Parse(conversiones[i].Rate);
                //        }
                ...
                //    //Currency CAD
                //    if (conversiones[i].Currency == "CAD")
                //    {
                //        if (conversiones[i].From == "CAD" && conversiones[i].To == "AUD" && conversiones[i].Currency == "CAD")
                //        {
                //            subtotal += decimal.Parse(conversiones[i].Amount);
                //            resultado = subtotal * decimal.Parse(conversiones[i].Rate);
                //        }

                //        if (conversiones[i].From == "CAD" && conversiones[i].To == "EUR" && conversiones[i].Currency == "CAD")
                //        {
                //            subtotal += decimal.Parse(conversiones[i].Amount);
                //            resultado = subtotal * decimal.Parse(conversiones[i].Rate);
                //        }

                //        if (conversiones[i].From == "CAD" && conversiones[i].To == "USD" && conversiones[i].Currency == "CAD")
                //        {
                //            subtotal += decimal.Parse(conversiones[i].Amount);
                //            resultado = subtotal * decimal.Parse(conversiones[i].Rate);
                //        }
                ...
                //    //Currency USD
                //    if (conversiones[i].Currency == "USD")
                //    {
                //        if (conversiones[i].From == "USD" && conversiones[i].To == "AUD" && conversiones[i].Currency == "USD")
                //        {
                //            subtotal += decimal.Parse(conversiones[i].Amount);
                //            resultado = subtotal * decimal.Parse(conversiones[i].Rate);
                //        }

                //        if (conversiones[i].From == "USD" && conversiones[i].To == "CAD" && conversiones[i].Currency == "USD")
                //        {
                //            subtotal += decimal.Parse(conversiones[i].Amount);
                //            resultado = subtotal * decimal.Parse(conversiones[i].Rate);
                //        }

                //        if (conversiones[i].From == "USD" && conversiones[i].To == "EUR" && conversiones[i].Currency == "USD")
                //        {
                //            subtotal += decimal.Parse(conversiones[i].Amount);
                //            resultado = subtotal * decimal.Parse(conversiones[i].Rate);
                //        }
